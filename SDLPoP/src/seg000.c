...
// seg000:0000
void pop_main() {
	// Initialize g_argv if not set (for ctypes/RL usage)
	static char* fake_argv[] = {"./prince", NULL};
...
// Helper for RL API - initializes doorlink pointers
void rl_init_doorlinks(void) {
...
// seg000:148D
int do_paused() {
	// Skip keyboard reading in RL step mode
	extern int rl_step_mode;
	if (rl_step_mode) return 0;
